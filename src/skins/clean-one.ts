...
import { CLEAN_ONE_TEMPLATES } from "./clean-one-templates.js";
...
// extractDigitBitmap and matchDigit are imported from ../template-matching.js
...
export function classifyCleanOneCell(
  ...
  if (darkPct + glyphPct > 0.5 && orangePct < 0.3) {
    ...
    return matchDigit(bitmap, CLEAN_ONE_TEMPLATES);
  }
